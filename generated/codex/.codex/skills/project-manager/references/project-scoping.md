...
- `<project-root>/plan.md` if it exists
...
- If the project is in a team repo, follow the **Shared Write Protocol** in AGENTS.md (pull first).
- Write `<project-root>/plan.md` with YAML frontmatter and the agreed content:
  ```
  ---
  updated: YYYY-MM-DD
