...
Explain **manual sync**: "OpenCode does not run an automatic workspace sync hook. Use the `/sync` command when you want to pull team repos before reading or writing shared artifacts."
